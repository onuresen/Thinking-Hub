...
| `canvas-hub.html` | Infinite spatial canvas — freeform sticky notes plus typed Goal/Project/R&D-bet nodes that can live-link to a real Goals Hub objective / Project Hub project (P110); multiple named boards, and typed connections (relates/blocks/depends-on) via a click popover (P111) |
